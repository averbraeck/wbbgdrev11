 ...
 */
public class LRPTextAnimation extends TextAnimation
{
    /** */
     ...
     */
    public LRPTextAnimation(final Locatable source, final String text, final float dx, final float dy,
    ...
    public TextAnimation clone(final Locatable newSource, final OTSSimulatorInterface newSimulator)
            throws RemoteException, NamingException
    {
        return new LRPTextAnimation(newSource, getText(), getDx(), getDy(), getTextAlignment(), getColor(), getFontSize(),
                newSimulator);
    }
