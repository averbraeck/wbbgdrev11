 ...
 */
public class RoadNTextAnimation extends TextAnimation
{
    /** */
     ...
     */
    public RoadNTextAnimation(final Locatable source, final String text, final float dx, final float dy,
    ...
    public TextAnimation clone(final Locatable newSource, final OTSSimulatorInterface newSimulator)
            throws RemoteException, NamingException
    {
        return new RoadNTextAnimation(newSource, getText(), getDx(), getDy(), getTextAlignment(), getColor(), getFontSize(),
                newSimulator);
    }
