    ...
    protected static class GisWaterwayImport implements OTSModelInterface
    {
                ...
                throws SimRuntimeException
        {
            ...
            try
            {
                ...
                {
                    System.out.println("Step 3: reading RMMS data for ROADS from infrastructure/_roads3.csv");
                    readRoadsCsv3("/infrastructure/_roads3.csv");
                }
                else if (new File("/infrastructure/_roads2.csv").canRead())
                {
                    System.out.println("Step 3: reading data for ROADS from infrastructure/_roads2.csv");
                    readRoadsCsv2("/infrastructure/_roads2.csv");
                }
                else if (new File("/infrastructure/_roads.tsv").canRead())
                {
                    System.out.println("Step 3: reading data for ROADS from infrastructure/_roads.tsv");
                    readRoadsTsv("/infrastructure/_roads.tsv");
                }
                else
                {
                    System.out.println("Step 3: reading data for ROADS from infrastructure/_roads3.csv");
        ...
        private void getWaterways(String initialDir, String fileName) throws NetworkException, OTSGeometryException
        {
            ...
            try
            {
                System.out.println("   - waterways try 1: URL = " + URLResource.getResource(initialDir + "/" + fileName + ".shp"));
            ...
            if (dataStoreLink == null)
            {
                ...
                {
                    System.out.println(
                            "   - waterways try 2: URL = " + URLResource.getResource("/" + initialDir + "/" + fileName + ".shp"));
            ...
            if (dataStoreLink == null)
            {
                System.err.println("could not read waterways from file " + initialDir + "/" + fileName);
                return;
            }
